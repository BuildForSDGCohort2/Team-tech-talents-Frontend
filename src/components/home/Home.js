              ...
              <div className="row">
                ...
                <div className="col-12 col-sm-6 col-md-4">
                  <div className="info-box mb-3">
                    ...
                    <div className="info-box-content">
                      <span className="info-box-text">Facilities</span>
                ...
                <div className="col-12 col-sm-6 col-md-4">
                  <div className="info-box mb-3">
                    ...
                    <div className="info-box-content">
                      <span className="info-box-text">Distribution</span>
                      ...
                      <div className="card-tools">
                        ...
                        <div className="btn-group">
                          ...
                          <div
                            ...
                            role="menu"
                          >
                            <a href="fake" className="dropdown-item">
                              Action
                            </a>
                            <a href="fake" className="dropdown-item">
                              Another action
                ...
                <div className="col-md-4">
                  ...
                  <div className="card">
                      ...
                      <ul className="products-list product-list-in-card pl-2 pr-2">
                        <li className="item">
                          ...
                          <div className="product-info">
                            <a href="message" className="product-title">
                              Samsung TV
                    ...
                    <div className="card-footer text-center">
                      <a href="message" className="uppercase">
                        View All Products
                      </a>
                    </div>
                    {/* /.card-footer */}
